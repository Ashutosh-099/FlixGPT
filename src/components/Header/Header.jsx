    ...
    <header className="w-full mx-auto absolute bg-gradient-to-b from-black z-10 sm:bg-black lg:bg-transparent lg:bg-gradient-to-b lg:from-black">
      <div className="w-9/12 mx-auto flex justify-between items-center flex-col lg:flex-row">
        <img
          ...
          onClick={() => {
            if (window.location.pathname !== routesPath.browse) {
              navigate(routesPath.browse);
            }
          }}
        />
        {userData.getValue() && (
          <div className="flex">
            {window.location.pathname === routesPath.gptSearchView && (
              <select
                className="p-2 px-4 bg-gray-900 text-white rounded-sm mr-4"
                onChange={(e) => {
            ...
            {window.location.pathname !== routesPath.gptSearchView && (
              <Tooltip title="Navigate to Flix GenAI">
                <button
                  className="mr-4"
                  onClick={() => {
